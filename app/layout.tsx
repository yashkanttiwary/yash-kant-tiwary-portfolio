...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: canonicalUrl,
    images: [{ url: socialImageUrl, width: 1731, height: 909, alt: "Yash Kant Tiwary - Creative Systems That Perform" }],
  },
  twitter: {
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en" className={`${geistSans.variable} ${geistMono.variable} ${barlowCondensed.variable}`}><body>{children}</body></html>;
}
